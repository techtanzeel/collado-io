...
![iomando app 2.0 — passwordless](../../../img/passwordless-login.jpg 'Here is how the passwordless feature works: no usernames, no emails, no passwords, no nothing')
...
![iomando app 2.0 — four doors support](../../../img/four-doors.jpg 'iomando 2.0 now supports up to four doors within the same space and screen')
...
![iomando app 2.0 — geolocation](../../../img/geolocation.jpg 'iomando will start using geolocation services on the phone to determine if a user is close enough to a certain access')
...
![iomando app 2.0 — multiplatform](../../../img/multiplatform.jpg 'iomando will continue to support both Android and iOS')
