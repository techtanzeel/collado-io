...
![iomando app 2.0 — old login](./iomando-20-old-login.jpg 'iomando old login involved name, email address, phone number and password')
...
![iomando app 2.0 — SMS code](./iomando-20-sms-code.jpg 'The user receives a code, which verifies her phone number the first time she logs in')
...
![iomando app 2.0 — passwordless login](./iomando-20-passwordless-login-2.jpg 'iomando 2.0 features a passwordless login, the only thing the user needs to do is to enter the SMS code she receives the first time she logs in')
...
![iomando app 2.0 — four-digit passcode lock](./iomando-20-four-digit-passcode.jpg 'Input speed was improved by automatically showing the numeric keyboard, but inevitably, security has inevitably hold back some of the smoothness')
...
![iomando app 2.0 — geolocation](./iomando-20-geolocation-2.jpg 'From the list, an admin is able to determine a global distance for the entire space, and if necessary, override the setting in a per-user basis')
