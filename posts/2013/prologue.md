...
This is the very first article of [the series](https://collado.io/iomando). It covers the story of the early days, and how the company evolved from just a piece of electronics and a few lines of code to a company still without a business model.
...
Mobile technologies were clearly a potential enabler for new businesses and opportunities, and great ideas were subtly popping around them. But they were still fragile and inconsistent. It was a no-brainer that something huge was about to happen in the space, but back then, it lacked shape and the *how* was still far from clear.
...
Everybody seemed to envision a bright future for the Internet of Things and *what would be possible* was a hot topic in the media. But sadly, still few understood how to build sustainable businesses models out of mobile technologies and a lot of companies were struggling to figure out ways to fit mobile in their current business strategy.

This is important because nowadays most of this stuff has been already figured out. But back in 2011, it was not. It is fairly easy to connect these dots looking backwards, but some of the markets as we know them, were partially locked because of technology constraints, and the IoT was definitely one of them.
...
* Interaction between physical and digital: the combination of the two first points defined the frontier between the physical world and personal digital experiences. In a way, our biological capabilities could be enhanced by these devices.
...
Back then though, we weren't thinking in terms of *solving a real problem* we just focused on *let's see what we can do with this*. We just wanted to gave utility and meaning to the device we just created.

We weren't looking for real problems or user needs because we didn't know that was an important part of building a great product or company (and yes, we were that lost...). We were blinded by the functionality, by the short term, and ultimately, we only wanted to put that thing in the hands of people.
...
![iomando first logo](http://res.cloudinary.com/dteii5unv/image/upload/v1522049013/blog/2013/iomando-logo.jpg "iomando logo")
